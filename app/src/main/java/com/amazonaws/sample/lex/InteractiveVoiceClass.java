...
public class InteractiveVoiceClass implements InteractiveVoiceView.InteractiveVoiceListener {
    ...
    public void callBackFromTextActivity(InteractiveVoiceView voiceView, Context context){
